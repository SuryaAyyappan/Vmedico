...
//
//import com.vmmedico.vmmedico.dto.*;
//import com.vmmedico.vmmedico.entity.*;
//import com.vmmedico.vmmedico.service.*;
...
//        if (patientService.phoneExists(request.getPhoneNumber()))
//            return badRequest("Phone number already exists");
//        if (patientService.emergencyContactExists(request.getEmergencyContact()))
...
//        if (userService.emailExists(request.getEmail()))
//            return badRequest("Email already exists");
//        if (doctorService.phoneExists(request.getPhoneNumber()))
//            return badRequest("Phone number already exists");
//        if (!isValidPassword(request.getPassword()))
//            return badRequest("Password must start with a capital letter, be at least 8 characters, and contain a special character (@,_ etc.)");
//
...
//        if (userService.emailExists(request.getEmail()))
//            return badRequest("Email already exists");
//        if (hospitalAdminService.phoneExists(request.getPhoneNumber()))
//            return badRequest("Phone number already exists");
//        if (!isValidPassword(request.getPassword()))
//            return badRequest("Password must start with a capital letter, be at least 8 characters, and contain a special character (@,_ etc.)");
//
//        try {
//            User user = createUser(request.getUsername(), request.getEmail(), request.getPhoneNumber(),
//                    request.getPassword(), User.Role.HOSPITAL_ADMIN);
//            User savedUser = userService.saveUser(user);
//
...
//
//            HospitalAdmin savedAdmin = hospitalAdminService.saveHospitalAdmin(admin);
//            return ResponseEntity.ok(new SuccessResponse("Hospital Admin registered successfully", savedAdmin));
//        } catch (Exception e) {
//            return badRequest("Error: " + e.getMessage());
//        }
//    }
...
//        if (userService.emailExists(request.getEmail()))
//            return badRequest("Email already exists");
//        if (labService.phoneExists(request.getPhoneNumber()))
//            return badRequest("Phone number already exists");
//        if (!isValidPassword(request.getPassword()))
//            return badRequest("Password must start with a capital letter, be at least 8 characters, and contain a special character (@,_ etc.)");
//
...
//            message.setFrom("sunilraj200419@gmail.com");
